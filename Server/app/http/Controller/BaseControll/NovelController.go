...
//func (BaseController *AuthDTO.BaseController) CreateProgramming(Ctx *gin.Context) {
//
...
//	if err != nil {
//		AuthDTO.HTTPErr(NovelCtx, err, 1001)
//		return
//	}
//
...
//}
//
//func (BaseController *AuthDTO.BaseController) CreateBranch(Ctx *gin.Context) {
//
...
//}
//
//func (BaseController *AuthDTO.BaseController) CreateCommit(Ctx *gin.Context) {
//
//	var CommitDTO DTO.CommitDTO
//	var CommitCtx = Ctx
//	err := CommitCtx.ShouldBind(&CommitDTO)
//	if err != nil {
//		AuthDTO.HTTPErr(Ctx, err, 1001)
//		return
//	}
//	err = BaseController.BaseService.CreateCommit(CommitCtx, &CommitDTO)
//}
//
//func (BaseController *AuthDTO.BaseController) Programming(Ctx *gin.Context) {
//
//	NoteID, exists := Ctx.GetQuery("NoteID")
//	if !exists {
//		AuthDTO.HTTPErr(Ctx, errors.New("NoteID is required"), 1001)
//		return
//	}
//	NoteIDNum, err := strconv.Atoi(NoteID)
//	if err != nil {
//		AuthDTO.HTTPErr(Ctx, errors.New("Failed to parse the data"), 1001)
//		return
//	}
//
...
//}
//
//func (BaseController *AuthDTO.BaseController) ChangeCommit(Ctx *gin.Context) {
//
//	var CommitDTO DTO.CommitDTO
//	var CommitCtx = Ctx
//	err := CommitCtx.ShouldBind(&CommitDTO)
...
//}
//
//func (BaseController *AuthDTO.BaseController) GetUserInfo(GetUserInfoCtx *gin.Context) {
//
//	//1.解析http请求,把参数从HttpMessage.ctx绑定到HttpMessage.DTO
//	UserID, exists := GetUserInfoCtx.GetQuery("UserID")
//	if !exists {
//		AuthDTO.HTTPErr(GetUserInfoCtx, errors.New("NoteID is required"), 1001)
//		return
//	}
//	_, err := strconv.Atoi(UserID)
//	if err != nil {
//		AuthDTO.HTTPErr(GetUserInfoCtx, errors.New("Failed to parse the data"), 1001)
//		return
//	}
