...
func (BaseService *NotAuthService.BaseService) CreateNovelProgramming(NovelDTO *DTO.NovelDTO) error {
...
func (BaseService *NotAuthService.BaseService) CreateBranch(BranchDTO *DTO.Branch) error {
...
func (BaseService *NotAuthService.BaseService) CreateCommit(commitCTX *gin.Context, CommitDTO *DTO.CommitDTO) error {
...
func (BaseService *NotAuthService.BaseService) Programming(NoteID int) (reposen.Note, error) {
...
func (BaseService *NotAuthService.BaseService) ChangeCommit(Ctx *gin.Context, CommitDTO *DTO.CommitDTO) error {
